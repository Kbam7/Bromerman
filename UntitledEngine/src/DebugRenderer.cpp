#include "../include/DebugRenderer.h"
...
UntitledEngine::DebugRenderer::DebugRenderer() {
    // Empty
}
...
void UntitledEngine::DebugRenderer::init() {
...
void UntitledEngine::DebugRenderer::end() {
    glBindBuffer(GL_ARRAY_BUFFER, m_vbo);
    // Orphan the buffer
...
void UntitledEngine::DebugRenderer::drawLine(const glm::vec2& a, const glm::vec2& b, const ColorRGBA8& color) {
    int i = m_verts.size();
...
void UntitledEngine::DebugRenderer::drawBox(const glm::vec4& destRect, const ColorRGBA8& color, float angle) {
...
void UntitledEngine::DebugRenderer::drawCircle(const glm::vec2& center, const ColorRGBA8& color, float radius) {
...
void UntitledEngine::DebugRenderer::render(const glm::mat4& projectionMatrix, float lineWidth) {
    m_program.use();
...
void UntitledEngine::DebugRenderer::dispose() {
    if (m_vao) {
